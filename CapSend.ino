...
void CapSave()
{
  ...
  // Opening in Binary Format to write 
  ...
  //Send Image Data File
  File savedFile = SD_MMC.open(path.c_str(), FILE_READ);
  if (!savedFile) {
  ...
  size_t bytesRead = savedFile.read(buffer, fileSize);
